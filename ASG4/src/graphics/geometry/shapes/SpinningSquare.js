...
class spinningSquare extends Geometry {
  ...
  generateSquareVertices(xPos, yPos, zPos, redVal, greenVal, blueVal, shapeMultiplier) {
    ...
    var vertex1 = new Vertex(-16, -.8, -16, 255, 0, 0);
    var vertex2 = new Vertex(-16, -.8, 16, 255, 0, 0);
    var vertex3 = new Vertex(16, -.8, -16, 255, 0, 0);
    var vertex4 = new Vertex(16, -.8, 16, 255, 0, 0);
