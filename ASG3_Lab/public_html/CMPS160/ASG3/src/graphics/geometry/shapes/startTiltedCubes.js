...
class startTiltedCubes extends Geometry {
  ...
  addVertexTextureCoordinates() {
    ...
    this.vertices[0].uv = [0,.5];
    this.vertices[1].uv = [0,0];
    this.vertices[2].uv = [1,.5];
    this.vertices[3].uv = [0,0];
    this.vertices[4].uv = [1,.5];
    ...
    this.vertices[14].uv = [2,1];
    this.vertices[15].uv = [0,0];
    this.vertices[16].uv = [2,1];
    this.vertices[17].uv = [2,0];
    ...
    //right faces
    this.vertices[24].uv = [0,3];
    this.vertices[25].uv = [0,0];
    this.vertices[26].uv = [3,3];
    this.vertices[27].uv = [0,0];
    this.vertices[28].uv = [3,3];
    this.vertices[29].uv = [3,0];

    //left faces
    this.vertices[30].uv = [0,1];
    this.vertices[31].uv = [0,0.5];
    this.vertices[32].uv = [1,1];
    this.vertices[33].uv = [0,0.5];
    this.vertices[34].uv = [1,1];
    this.vertices[35].uv = [1,0.5];
