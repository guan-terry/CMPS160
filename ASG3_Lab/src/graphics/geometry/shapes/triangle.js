...
class Triangle extends Geometry {
  ...
  generateTriangleVertices(xPos, yPos, redVal, greenVal, blueVal, sizeMultiplier, isRainbow) {
    var vertices = []
    if (isRainbow) {
      var vertex1 = new Vertex(xPos, yPos + (0.135 * sizeMultiplier), 0.0, Math.random(), Math.random(), Math.random());
      var vertex2 = new Vertex(xPos - (0.135 * sizeMultiplier), yPos - (0.135 * sizeMultiplier), 0.0, Math.random(), Math.random(), Math.random());
      var vertex3 = new Vertex(xPos + (0.135 * sizeMultiplier), yPos - (0.135 * sizeMultiplier), 0.0, Math.random(), Math.random(), Math.random());
    } else {
