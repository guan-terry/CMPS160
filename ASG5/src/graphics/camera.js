...
class Camera {
  ...
  constructor(shader) {
    ...
    this.projectionMatrix.setOrtho(this.left, this.right, this.bottom, this.top, this.near, 15);
  }
...
//    this.up = this.up.add(u);
  ...
  changePerspective() {
    if (!this.isProjection) {
      this.projectionMatrix.setFrustum(this.left, this.right, this.bottom, this.top, this.near, 15);
